  ...
  return (
    ...
    >
      <div
        ...
        } bg-white rounded-2xl shadow-lg focus:outline-none ${
          maxHeight ?? ''
        } max-h-[90vh] flex flex-col`}
      >
        {/* Header */}
        {title && (
          <div className="sticky top-0 z-10 flex justify-between items-center border-b px-6 py-4 bg-white rounded-t-2xl">
            <div className="flex items-center gap-2">
              ...
              <div className="">
                ...
                <h4 className="text-[#64748B] text-xs">{description}</h4>
              </div>
            </div>
            {showCloseIcon && (
              <button
